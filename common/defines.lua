...
NDiplomacy = {
	...
	CELESTIAL_EMPIRE_REFORM_COST = 25,				-- Mandate cost of enacting a new reform for the Emperor of China.
	CELESTIAL_EMPIRE_REFORM_STABILITY_COST = 0,		-- Stability cost of enacting a new reform for the Emperor of China
...
NCountry = {
	...
	BASE_POSSIBLE_POLICIES = 5,						-- How many policies in a category a nation can have as a base
	...
	BREAK_TRIBUTARY_STABILITY_PENALTY = 0,			-- Stability penalty when break Tributary
...
NMilitary = {
	...
	ARTILLERY_COST = 75.0, 							-- _MDEF_ARTILLERY_COST = 10,
